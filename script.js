...
ocultismo = localStorage.getItem('ocultismo')
...
function vidahtml(vida){
  ...
  var html = ""
	...
	html += "<tr><td>Pontos de ocultismo:</td>"
    html += "<td>"+ ocultismo + "/" + ocultismomax + "</td>"
    html +="<td><button onClick='adicionarpo()'>Cura </button></td></tr>"
...
function adicionarpo(){
	...
	ocultismo=ocultismo-1
	ocultismo=ocultismo + 2
...
html9 += "<tr><td>Nome</td><td>Ethan Volkov</td></tr>"

html9 += "<tr><td>Jogador</td><td>Bryan</td></tr>"

html9 += "<tr><td>Ocupação</td><td>Músico</td></tr>"

html9 += "<tr><td>Idade</td><td>49</td></tr>"

html9 += "<tr><td>Gênero</td><td>Masculino</td></tr>"
...
function pericias(vida){
	...
	html3 +="<td>18</td>"
	html3 +="<td><button onClick='roll18()'>ROLL</button></td></tr>"
	...
	html3 +="<td>11</td>"
	html3 +="<td><button onClick='roll11()'>ROLL</button></td></tr>"
...
rituais(vida)
function rituais(vida){
var html20 =""

html20 +="<tr><th colspan='7'>Rituais</th></tr>"

html20 += "<tr><td>Nome</td><td colspan='2'>Descrição</td><td>Custo De Sanidade</td><td>Custo De Pontos de Ocultismo</td><td>Usar</td></tr>"

html20 += "<tr><td>Mãos Espectrais</td><td colspan='2'>Rodadas: 1d3 |2 de vantagem(possivel dar 2 socos) | Mãos roxas gigantes</td><td>1d10</td><td>Tudo (min:5)</td><td><button onClick='maosespactrais()'>Usar Ritual</button></td></tr>"

html20 += "<tr><td>Sangramento Continuo</td><td colspan='2'></td><td>0/d6</td><td>9</td><td><button onClick='sangramento()'>Usar Ritual</button></td></tr>"

html20 += "<tr><td>Quimar Flamejante</td><td colspan='2'></td><td>2/1d6</td><td>9</td><td><button onClick='quimar()'>Usar Ritual</button></td></tr>"

	var rituais = document.getElementById("rituais")
  rituais.innerHTML = html20

}

function maosespactrais(){

	if(ocultismo>=5){

		ocultismo=ocultismo-ocultismo
		sanidadeatual = sanidadeatual - parseInt(prompt('Quanto dano de sanidade levou por este ritual?'))
		alert('Ritual conjurado com sucesso :)')


		localStorage.setItem("ocultismo", ocultismo)
		localStorage.setItem("sanidade",sanidadeatual)
	}else{
		alert('Não tem pontos de ocultismo suficientes')
	}
